                ...
                <form action="update.php" method="post">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="barcode" class="col-form-label">SKU</label>
                            <input type="text" class="form-control" id="barcode" name="barcode" placeholder="SKU" required value="<?= $product['barcode'] ?>">
                        </div>
                        <div class="form-group col-md-6">
